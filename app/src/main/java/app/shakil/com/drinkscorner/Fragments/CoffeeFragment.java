...
public class CoffeeFragment extends Fragment {
    ...
    private void insertData() {
        coffeeItemList.add(new CoffeeItem(R.drawable.coffee,"Flat White","The two most Kiwi coffees available are the long black and the flat white " +
                "– as both originated in New Zealand and Australia.",6.7,4.8));
        coffeeItemList.add(new CoffeeItem(R.drawable.coffee,"Long Black","Hot water is poured into a cup, and then two shots of espresso are poured " +
                "into the water. If you do the inverse of this, it will result in an Americano.",11.9,4.9));
        coffeeItemList.add(new CoffeeItem(R.drawable.coffee,"Mochaccino","A ‘mocha’ is just a latte with added chocolate powder or syrup, " +
                "as well as sometimes being topped with whipped cream. ",6.7,4.8));
        coffeeItemList.add(new CoffeeItem(R.drawable.coffee,"Irish Coffee","Too many of these and you might have to ‘just crash here, bro’," +
                " because this type of coffee is brewed with whiskey, sugar, and a thick layer of cream on the top",6.7,4.8));
        coffeeItemList.add(new CoffeeItem(R.drawable.coffee,"Vienna","A Vienna is made by adding two shots of particularly strong espresso" +
                " together before whipped cream is added as a substitute for milk and sugar. ",6.7,4.8));
        coffeeItemList.add(new CoffeeItem(R.drawable.coffee,"Affogato","Affogatos aren’t a coffee at all really, as they’re a shot of" +
